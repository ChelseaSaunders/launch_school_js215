...
// Create a variable named language and set it equal to 'JavaScript'. Find the i
// ndex of the first occurrence of the letter 'S' and save it to a variable named
...
// ***
// String.prototype.substr() has been deprecated. As a result, it should not be
...
// a String using the toString method. Search the resulting string for the final
